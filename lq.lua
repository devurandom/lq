...
local index_selector = dot * literal("[") * withspace(all_literals) * literal("]")
local slice_selector = dot * literal("[") * withspace(digits/tonumber) * literal(":") * withspace(digits/tonumber) * literal("]")
local value_selector = literal(".[]")
